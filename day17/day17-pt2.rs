...
fn step( map: &Vec<Vec<u32>> , paths : &mut Vec<Data>) {
    ...
    while !paths.is_empty() {
        ...
        for path in &mut *paths {
            ...
            if x==map[0].len()-1 && y==map.len()-1 && path.heatloss < val_found && direction.1 > 4 {
            ...
            if direction.0 == 0 {  // >
                ...
                if x+1< map[0].len() && direction.1 < 10 {  
                    new_paths.push(Data {
